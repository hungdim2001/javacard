...
public class supermarket extends Applet implements SUPERMARKET_CONSTANTS, ExtendedLength, MarketInterface 
{
	...
	{
		new supermarket(bArray, (short) (bOffset + 1), bArray[bOffset]);
	}
	private supermarket(byte[] bArray, short bOffset, byte bLength){
	...
	public void process(APDU apdu)
	{
		...
		case INS_SHOW: 
			...
			// xóa s tin hin ti trýc khi gi
		...
		case INS_THANHTOAN:
			...
			//8 byte sau la so diem tru,  byte tiep theo  là index ma giam gia de su dung,
	...
	private void naptien(APDU apdu){
		...
		short i=0;
		// Gii m ; s tin là 54.321 s lýu là 000000054321
		// Khi np s tin là 362 s chuyn thành 000000000362 khi gi
	...
	private void thanhtoan(APDU apdu){
		...
		if (nho == 1) {
			...
			ISOException.throwIt(SUPERMARKET_CONSTANTS.SW_LACK_MONEY);
		}
		// Tính tong thanh toán
		nho = (byte)0;
	...
	{
		if(parameter != SUPERMARKET_CONSTANTS.PARAMETER_INTERFACE) return null;
		return this;
	}
